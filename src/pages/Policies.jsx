...
const Dropdown = () => {
  ...
  return (
    <>
      ...
      {/* Background Section */}
      <div
        className="flex justify-center items-center h-auto bg-fixed bg-cover bg-center pt-20"
      ...
      >
        <div className="w-full px-8 py-16">
          ...
          {/* Dropdown Section */}
          <div className="bg-gray-400 bg-opacity-60 rounded-lg shadow-lg p-6">
            {items.map((item, index) => (
              <div
                key={index}
                className="border-b-2 border-secondary last:border-b-0 mb-4"
              >
                {/* Title */}
                <button
                  onClick={() => toggleItem(index)}
                  className="w-full text-left flex justify-between items-center p-4 text-green-700 text-[20px] font-semibold focus:outline-none tracking-[0.1em] bg-transparent"
                >
