...
const Footer = () => {
  return (
<footer className="bg-white flex flex-col justify-center items-center px-4">
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 container bg-gray-300">
