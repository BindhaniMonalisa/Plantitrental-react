  ...
  return (
    <div className='shadow-lg transition-all duration-500 hover:shadow-xl bg-white dark:text-white cursor-pointer mb-3  border border-solid  border-secondary'>
        <div className="overflow-hidden ">
            ...
            <button className="bg-secondary px-4 py-2 text-white rounded-full border-2 border-green-600 text-sm font-semibold hover:bg-green-600 hover:text-white transition duration-300  relative mt-[-20px] ml-0 left-[115px] row-start-3 justify-center">
          Browse Items
        </button>
        </div>
        ...
        <h1 className="line-clamp-1 font-semibold text-green-600 text-[26px] underline ">{title}</h1>
